            ...
            match randint(1, 6):
                case 1:
                    ...
                    bpy.ops.zomboid.add_clothing_item(
                        guid='e4ec9087-006d-41dc-81f4-585b6d2e958c', generate_mask=False, create_body_texture=False)
                case 2:
                    # Tintable Default T-Shirt
                    bpy.ops.zomboid.add_clothing_item(
                        guid='19af00e4-ed4d-49bc-a893-a4a3376fe6da', generate_mask=False, create_body_texture=False)
                case 3:
                    # Standard Default T-Shirt w/ Decal
                    bpy.ops.zomboid.add_clothing_item(
                        guid='d0616b36-b727-4c08-9274-020cb2e72bf8', generate_mask=False, create_body_texture=False)
                case 4:
                    # Tintable Default T-Shirt w/ Decal
                    bpy.ops.zomboid.add_clothing_item(
                        guid='53b95680-245b-4439-8ba7-5aa6d938e465', generate_mask=False, create_body_texture=False)
                case 5:
                    # Standard Default Vest
                    bpy.ops.zomboid.add_clothing_item(
                        guid='903c06ea-78e7-4f42-a3da-768be61f216f', generate_mask=False, create_body_texture=False)
                case 6:
                    # Tintable Default Vest
                    bpy.ops.zomboid.add_clothing_item(
                        guid='a700a956-32c2-49a6-bd5f-5a2895073f19', generate_mask=False, create_body_texture=False)
        ...
        if self.random_pants:
            match randint(1, 3):
                case 1:
                    ...
                    bpy.ops.zomboid.add_clothing_item(
                        guid='e4b71599-604d-4cc7-9ce4-7723a7e37d8a', generate_mask=False, create_body_texture=False)
                case 2:
                    # Hue-able Default Trousers
                    bpy.ops.zomboid.add_clothing_item(
                        guid='5b07d45e-84c9-4ddf-ad6e-4bc2f27cace7', generate_mask=False, create_body_texture=False)
                case 3:
                    # Tintable Default Trousers
                    bpy.ops.zomboid.add_clothing_item(
                        guid='1e2ed52f-9ee7-464b-9581-a450f2fbb403', generate_mask=False, create_body_texture=False)
