...
class PZ_HumanRig_SortBodyClothingTextures(Operator):
    ...
    def execute(self, context):
        ...
        for index, item in enumerate(equipped_clothing):
            ...
            # Only store body textures
            if item.data.clothing_type == 'BODYTEXTURE' and item.data.body_location is not None:
        ...
        for i in range(len(equipped_clothing) - 1, -1, -1):
            ...
            if clothing.data.clothing_type == 'BODYTEXTURE' and item.data.body_location is not None:
        ...
        for index, item in enumerate(sorted_list):
            ...
            equipped_clothing.move(len(equipped_clothing) - 1, original_indicies[index])
